...
Level.find_or_create_by(name: "Cub")
Level.find_or_create_by(name: "Puma")
Level.find_or_create_by(name: "Wildcat")
Level.find_or_create_by(name: "Lion")
...
Girl.find_or_create_by(first_name: "Meg", last_name: "March", dob: "01/19/2007", level: Puma, dietary: "none", fallgrade: "4", parentcell: "614-555-1020", troopnumber: "OH3030", tshirt: GirlMedium, session_A: ASessions.first, session_B: BSessions.last, session_C: CSessions.first, session_D: DSessions.last, cooking_session:"None", high_ropes:true)
Girl.find_or_create_by(first_name: "Anne", last_name: "Shirley", dob: "01/19/2006", level: Lion, dietary: "none", fallgrade: "5", parentcell: "614-555-1011", troopnumber: "OH3030", tshirt: GirlMedium, session_A: ASessions.last, session_B: BSessions.first, session_C: CSessions.second, session_D: DSessions.last, cooking_session:"None", high_ropes:false)
Girl.find_or_create_by(first_name: "Marianne", last_name: "Dashwood", dob: "01/19/2009", level: Cub, dietary: "none", no_gluten:true, fallgrade: "3", parentcell: "614-565-9019", troopnumber: "OH3030", tshirt: GirlMedium, session_A: ASessions.last, session_B: BSessions.first, session_C: CSessions.second, session_D: DSessions.last, cooking_session:"None", high_ropes:false)
