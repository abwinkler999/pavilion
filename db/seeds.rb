...
Session.find_or_create_by(name: "Pottery", description: "Introduction to pot-throwing.", slot: Slot.second, restriction: Restriction.find_by(name:"All"))
Session.find_or_create_by(name: "Fire Building", description: "Learning to build a campfire.", slot: Slot.second, restriction: Restriction.find_by(name:"All"))